...
window.addEventListener('load', async () => {
    ...
    navigation.registerForm('loginForm', onLoginSubmit, () => {
        page.redirect('/');
        navigation.setUserNav();
    });

    page('/register', views.registerView);
    navigation.registerForm('registerForm', onRegisterSubmit, () => {
        page.redirect('/');
        navigation.setUserNav();
    });

    page('/create', views.createView);
    navigation.registerForm('createForm', onCreateSubmit, (recipeId) =>
