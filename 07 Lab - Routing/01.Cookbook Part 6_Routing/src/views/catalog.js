...
const catalogTemplate = (recipes, page, pages, search) => html` <section id="catalog">
...
const pager = (page, pages, search) => html` Page ${page} of ${pages}
${page > 1
    ? html`<a class="pager" href=${'/catalog/' + (page - 1) + (search ? `?search=${search}` : '')}
          >&lt; Prev</a
      >`
    : ''}
${page < pages
