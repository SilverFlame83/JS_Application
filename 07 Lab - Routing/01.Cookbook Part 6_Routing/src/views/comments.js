...
const commentsTemplate = (recipe, commentForm, comments) => html` <div class="section-title">
...
const commentFormTemplate = (active, toggleForm, onSubmit) => html` <article class="new-comment">
    ${active
