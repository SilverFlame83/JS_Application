...
const homeTemplate = (recentRecipes) => html` <section id="home">
    <div class="hero">
        <h2>Welcome to My Cookbook</h2>
    </div>
    <header class="section-title">Recently added recipes</header>
    <div class="recent-recipes">
        ${recentRecipes[0] ? recentRecipe(recentRecipes[0]) : ''} ${spacer()}
        ${recentRecipes[1] ? recentRecipe(recentRecipes[1]) : ''} ${spacer()}
...
const recentRecipe = (recipe) => html` <a class="card" href=${`/details/${recipe._id}`}>
